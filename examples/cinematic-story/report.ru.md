...
Пакет управляет кадрированием, глубиной, появлением и режимом reduced motion. Источник передаёт одно
...
Прокрутка меняет акцент, а порядок источника и reduced motion сохраняют полный рассказ.
:::
...
контекстом или темой. Для декоративных картинок лучше выбрать отчётный preset.
:::
::::::
