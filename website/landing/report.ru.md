...
собирает переносимый HTML с адаптивной композицией, взаимодействиями, локализацией и ревью выделенного
текста.
...
медиа и движение. Рецепты разделов строят рассказ без длинной стены визуальных атрибутов.
:::
...
::::cards
:::card{title="Отчёт о решении · Monument" href="examples/basic/index.html"}
...
Monument выбран по умолчанию. Material, Signal, Terminal и Cinematic отличаются композицией, типографикой,
