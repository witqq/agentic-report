...
For a reproducible 0.2.1 run, create a new landing-page source and keep the package version pinned through
validation, inspection, and build:

```sh
npx --yes agentic-report@0.2.1 init ./my-page --starter landing --json
npx --yes agentic-report@0.2.1 validate ./my-page --json
npx --yes agentic-report@0.2.1 inspect ./my-page --json
...
```sh
npx --yes agentic-report@0.2.1 describe --json
npx --yes agentic-report@0.2.1 schema --scope source
npx --yes agentic-report@0.2.1 examples --json
```
