...
For a reproducible 0.2.2 run, create a new landing-page source and keep the package version pinned through
validation, inspection, and build:

```sh
npx --yes agentic-report@0.2.2 init ./my-page --starter landing --json
npx --yes agentic-report@0.2.2 validate ./my-page --json
npx --yes agentic-report@0.2.2 inspect ./my-page --json
...
```sh
npx --yes agentic-report@0.2.2 describe --json
npx --yes agentic-report@0.2.2 schema --scope source
npx --yes agentic-report@0.2.2 examples --json
```
