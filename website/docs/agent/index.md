...
For a reproducible 0.3.3 run, create a new landing-page source and keep the package version pinned through
validation, inspection, and build:

```sh
npx --yes agentic-report@0.3.3 init ./my-page --starter landing --json
npx --yes agentic-report@0.3.3 validate ./my-page --json
npx --yes agentic-report@0.3.3 inspect ./my-page --json
npx --yes agentic-report@0.3.3 build ./my-page --output ./my-page.html --json
```
...
```sh
npx --yes agentic-report@0.3.3 describe --json
npx --yes agentic-report@0.3.3 schema --scope source
npx --yes agentic-report@0.3.3 examples --json
```
