...
```bash
npx --yes agentic-report@0.14.0 init ./my-report --starter report --json
# Edit ./my-report/report.md and its local assets.
npx --yes agentic-report@0.14.0 build ./my-report --output ./my-report.html --json
```
...
phrase and choose **Create note**; no review mode is required. The selection may cross inline markup or end
